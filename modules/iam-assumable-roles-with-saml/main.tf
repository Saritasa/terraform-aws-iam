...
resource "aws_iam_role" "admin" {
  ...
  assume_role_policy    = var.admin_assume_role_policy != "" ? var.admin_assume_role_policy : data.aws_iam_policy_document.assume_role_with_saml.json
...
resource "aws_iam_role" "poweruser" {
  ...
  assume_role_policy    = var.poweruser_assume_role_policy != "" ? var.poweruser_assume_role_policy : data.aws_iam_policy_document.assume_role_with_saml.json
...
resource "aws_iam_role" "readonly" {
  ...
  assume_role_policy    = var.readonly_assume_role_policy != "" ? var.readonly_assume_role_policy : data.aws_iam_policy_document.assume_role_with_saml.json
